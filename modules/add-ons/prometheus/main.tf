/**
 * # Prometheus IAM Role Module
 *
 * This module creates the necessary IAM roles and policies for the Prometheus add-on.
 */
...
data "aws_iam_policy_document" "this" {
  ...
  statement {
    ...
    condition {
      ...
      values   = ["system:serviceaccount:monitoring:${local.name}"]
    }
